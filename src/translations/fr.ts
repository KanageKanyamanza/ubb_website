...
export const fr = {
  ...
  home: {
    ...
    problem: {
      title: "Votre entreprise croît, mais quelque chose freine.",
      subtitle: "La plupart des entreprises africaines établies font face aux mêmes blocages structurels.",
      card1Title: "Ventes stagnantes",
      card1Text: "L'activité existe mais les revenus plafonnent. Les efforts commerciaux ne se traduisent pas en croissance visible.",
      card2Title: "Opérations désorganisées",
      card2Text: "Les équipes travaillent fort, mais sans système clair. L'information se perd, les décisions tardent.",
      card3Title: "Manque de visibilité financière",
      card3Text: "Difficile de savoir où va l'argent, ce qui est rentable et quels leviers activer en priorité.",
      dividerText: "UBB a conçu une réponse structurée à ces trois défis."
    },
    solution: {
    ...
    vitalcheck: {
      tag: "Outil de diagnostic",
      titleLine1: "Connaissez-vous vraiment",
      titleLine2: "les freins de votre entreprise ?",
      desc: "vitalCHECK est notre outil de diagnostic en ligne. En quelques minutes, il identifie les goulots d'étranglement de votre marketing, vos opérations et vos finances — et génère un rapport d'action personnalisé.",
      bullet1: "Diagnostic complet en moins de 15 minutes",
      bullet2: "Rapport personnalisé avec recommandations prioritaires",
      bullet3: "Conçu pour les réalités des entreprises africaines",
      cta: "Faire mon diagnostic gratuit"
    },
    harvests: {
      tag: "Suite logicielle",
      titleLine1: "Pilotez vos ventes et",
      titleLine2: "opérations en temps réel.",
      desc: "HARVESTS 2.0 est une suite logicielle de gestion commerciale conçue pour les réalités du marché africain. Suivi des ventes, gestion des équipes, tableaux de bord — tout ce dont votre équipe a besoin pour performer chaque jour.",
      bullet1: "Interface adaptée aux marchés africains",
      bullet2: "Suivi commercial et reporting en temps réel",
      bullet3: "Intégration facile avec vos processus existants",
      cta: "Découvrir HARVESTS 2.0"
    },
    caseStudy: {
      tag: "Étude de cas réelle",
      titleLine1: "De zéro à record de ventes.",
      titleLine2: "En 90 jours.",
      metric1Title: "Diagnostic complet",
      metric2Title: "Résultats concrets",
      metric3Title: "Record battu",
      quote: "Il y a quelques années, j'ai aidé une entreprise manufacturière en difficulté en Afrique. En trois mois, grâce à un diagnostic rigoureux et à la magie des réunions quotidiennes, l'entreprise a atteint des records de ventes — un exploit inédit en 11 ans d'existence.",
      ...
      ctaSecondary: "Découvrir son parcours"
    },
    ecosystem: {
      title: "L'écosystème UBB",
      subtitle: "Conseil, SaaS et formation — une réponse intégrée pour chaque étape de votre croissance.",
      bubble1: "Diagnostiquer",
      bubble2: "Structurer",
      bubble3: "Piloter",
      summary: "Commencez par un diagnostic vitalCHECK, laissez notre équipe structurer votre plan de croissance, puis pilotez vos résultats avec HARVESTS 2.0.",
    ...
    finalCta: {
      titleLine1: "Votre entreprise mérite",
      titleLine2: "de croître.",
      italicText: "Commencez par comprendre ce qui la freine.",
      desc: "Un diagnostic vitalCHECK prend moins de 15 minutes. Notre équipe analyse les résultats et vous contacte sous 48 heures avec un plan d'action personnalisé.",
      ctaPrimary: "Démarrer mon diagnostic gratuit",
      ctaSecondary: "Nous contacter directement",
      disclaimer: "Aucun engagement. Réponse en 48h."
    }
  },
  team: {
    ...
    hero: {
      ...
      titleLine1: "Des experts engagés",
    ...
    chips: {
      ...
      "Finance numérique": "Finance numérique",
      "Projets": "Projets",
      "React": "React",
      "Next.js": "Next.js",
      "Laravel": "Laravel",
  ...
  founder: {
    ...
    stats: {
      val1: "15 jours",
      lbl1: "Pour un diagnostic complet",
      val2: "90 jours",
      lbl2: "Pour des résultats mesurables",
      val3: "11 ans",
      lbl3: "De record battu en 3 mois",
      val4: "Ubuntu",
      lbl4: "Au cœur de chaque mission"
    },
    expertise: {
    ...
    philosophy: {
      title: "Je suis parce que nous sommes.",
    ...
    cta: {
      title: "Travailler avec Ambrose",
      desc: "Chaque mission commence par un diagnostic. Parlons de votre entreprise.",
      ctaPrimary: "Démarrer mon diagnostic",
      ctaSecondary: "← Retour à l'équipe"
    }
  },
  jobs: {
  ...
  register: {
    ...
    form: {
      title: "Rejoindre la communauté",
      subtitle: "Bénéficiez de 15% de réduction immédiate sur nos e-books et de l'accès gratuit à nos diagnostics.",
      firstName: "Prénom",
      lastName: "Nom",
      ...
      successDesc: "Votre inscription est validée. Vous allez recevoir un email de confirmation contenant votre code de réduction et vos premiers accès sous quelques minutes.",
      successCta: "Explorer les e-books"
    }
  },
  ebooks: {
    ...
    hero: {
      ...
      titleLine2: "À votre propre rythme.",
    ...
    journey: {
      ...
      subtitle: "Les ressources sont la première étape. Voici la suite.",
      step1Tag: "Vous êtes ici",
      step1Title: "Ressources",
      step1Subtitle: "E-books & formations",
      step1Desc: "Apprenez les fondamentaux de la croissance structurée à votre rythme.",
      step2Title: "vitalCHECK",
      step2Subtitle: "Diagnostic de votre entreprise",
      step2Desc: "Identifiez précisément les freins de votre entreprise. Rapport personnalisé.",
      step2Cta: "En savoir plus",
      step3Title: "Conseil UBB",
      step3Subtitle: "Accompagnement personnalisé",
      step3Desc: "Notre équipe travaille avec vous sur le terrain pour transformer votre entreprise.",
      step3Cta: "Nous contacter"
    },
    items: {
      item1Title: "Structurer sa croissance en 90 jours",
      ...
      item3Title: "L'écosystème des incubateurs au Sénégal",
      item3Desc: "Comment intégrer le cercle restreint des projets qui décrochent un financement ?",
    ...
    assurance: {
      ...
      card1Desc: "Vous recevez vos ressources par email dès confirmation du paiement.",
      card2Title: "Conçu pour l'Afrique",
      card2Desc: "Contenu adapté aux réalités des marchés et entreprises africains.",
      card3Title: "Paiement sécurisé",
      card3Desc: "Paiement via PayPal — protection acheteur incluse sur chaque transaction.",
      disclaimer: "Le paiement est traité en livres sterling (GBP) via PayPal. Le montant de {price} correspond à £{gbp} au taux actuel. Votre banque ou PayPal effectue la conversion automatiquement."
    },
    checkout: {
    ...
    upsell: {
      ...
      desc: "Les ressources donnent les bases. vitalCHECK identifie exactement ce qui freine votre entreprise. Notre équipe prend ensuite le relais pour transformer ces insights en résultats mesurables.",
      ctaPrimary: "Faire mon diagnostic vitalCHECK",
  ...
  workbook: {
    ...
    left: {
      ...
      item2Title: "Exercices pratiques",
      item2Desc: "Des templates et check-lists directement applicables à votre contexte africain.",
      item3Title: "Applicable immédiatement",
      item3Desc: "Pas de théorie creuse. Des actions concrètes que vous pouvez commencer dès aujourd'hui.",
      valueLabel: "Valeur réelle",
      valuePrice: "£20",
      valuePromo: "Offert gratuitement aujourd'hui"
    },
    form: {
      title: "Recevoir votre workbook",
      subtitle: "Remplissez le formulaire ci-dessous. Vous recevrez le PDF par email sous 24h.",
      firstName: "Prénom *",
      lastName: "Nom *",
      email: "Email *",
      ...
      successDesc: "Votre workbook est en route. Vous le recevrez à {email} dans les prochaines 24 heures.",
      successPromo: "En attendant, prenez 15 minutes pour faire votre diagnostic vitalCHECK — c'est gratuit.",
      successCta: "Faire mon diagnostic"
    }
  },
  contact: {
    ...
    hero: {
      ...
      desc: "Notre équipe est là pour répondre à toutes vos questions et vous accompagner vers la croissance."
    },
    info: {
      phone: "Téléphone",
      email: "Email",
      office: "Bureau",
      officeLines: ["Dakar, Sénégal", "Afrique"],
      availability: "Disponibilité",
      availabilityLines: ["Lun – Ven : 8h – 18h", "Réponse sous 48h"],
      quickDiagnostic: "Envie d'un diagnostic rapide ?"
    },
    form: {
      title: "Envoyez-nous un message",
      subtitle: "Nous vous répondons dans les 48 heures ouvrées.",
      ...
      message: "Message *",
      messagePlaceholder: "Décrivez votre entreprise, vos défis actuels et ce que vous attendez de notre collaboration...",
    ...
    success: {
      ...
      desc: "Merci {name}. Notre équipe vous répondra à {email} dans les 48h.",
  ...
  actualites: {
    ...
    noPubs: {
      ...
      desc: "Aucune publication dans cette catégorie pour le moment.",
    ...
    tools: {
      ...
      vitalcheck: {
        ...
        desc: "Identifiez en quelques minutes les freins à la croissance de votre entreprise. Rapport personnalisé avec recommandations concrètes.",
        speed: "⚡ Résultats en moins de 15 minutes",
        cta: "Démarrer le diagnostic"
      },
      harvests: {
        badge: "📊 Suite logicielle",
        desc: "Pilotez vos ventes, vos équipes et vos opérations en temps réel. Conçu pour les réalités du marché africain.",
        tag: "🌍 Adapté aux marchés africains",
        cta: "Découvrir HARVESTS"
      }
    },
    ctaNewsletter: {
      title: "Ne manquez aucune actualité UBB",
      desc: "Webinaires, nouvelles fonctionnalités, études de cas — rejoignez la communauté UBB.",
      cta: "S'inscrire"
    }
  },
  chatbot: {
    welcome: "Bonjour ! Je suis l'assistant IA d'UBB. Comment puis-je vous aider aujourd'hui ?",
  ...
  vitalcheckPopup: {
    badge: "Recommandé",
    title: "Votre entreprise stagne ?",
    desc: "Faites un diagnostic complet en 15 minutes avec notre outil vitalCHECK.",
    cta: "Démarrer le diagnostic",
